...
assert.doesNotMatch(player, /client\.post\(`\/api\/lessons\/\$\{lessonId\}\/html-attempts`/);
assert.match(player, /resource\.attemptToken/);
assert.match(player, /resource\.attemptsExhausted/);
assert.match(player, /resource\.remainingAttempts/);
...
assert.match(player, /Agotaste tus intentos/u);
assert.match(player, /evaluable && !viewOnly/);
