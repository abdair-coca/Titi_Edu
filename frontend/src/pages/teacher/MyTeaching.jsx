      ...
      <div className="p-4 flex flex-col gap-2 flex-1">
        ...
        <div className="mt-auto pt-3 flex flex-wrap gap-2">
          ...
          <button
            type="button"
            onClick={onEdit}
            className="bg-white text-titi-dark font-bold text-sm px-3 py-2 rounded-xl border-2 border-gray-200 shadow-[0_4px_0px_#E5E7EB] hover:border-titi-yellow hover:-translate-y-0.5 hover:shadow-[0_6px_0px_#E5E7EB] active:translate-y-0.5 active:shadow-none transition-all duration-150"
          >
            Datos
          </button>
        </div>
