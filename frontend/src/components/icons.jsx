...
// Corazón — likes (tab de perfil). `filled` para el estado activo.
...
// Marcador — guardados (tab de perfil). `filled` para el estado activo.
...
// Grilla — tab de posts del perfil.
...
// Pin de mapa — ubicación del perfil.
