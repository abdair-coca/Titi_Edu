...
const mocks = vi.hoisted(() => {
  ...
  const client = {
    ...
    modulo: { findMany: vi.fn(), findUnique: vi.fn(), create: vi.fn(), update: vi.fn(), updateMany: vi.fn(), delete: vi.fn(), deleteMany: vi.fn() },
    ...
    opcion: { deleteMany: vi.fn(), createMany: vi.fn(), count: vi.fn() },
    intento: { findMany: vi.fn(), count: vi.fn(), deleteMany: vi.fn() },
    progreso: { count: vi.fn(), deleteMany: vi.fn() },
